...
data_files.append(
    (
        ...
        ["protos/ElkapodSimplified.proto", "protos/ElkapodV1.proto"],
    )
)
data_files.append(("share/" + package_name + "/meshes", glob("meshes/*.STL")))
data_files.append(("share/" + package_name + "/resource", ["resource/my_robot.urdf"]))
data_files.append(("share/" + package_name, ["package.xml"]))
data_files.append(
    (
        "share/" + package_name + "/" + package_name,
        ["elkapod_sim/elkapod_simulation_comm_server.py"],
    )
)
...
setup(
    ...
    entry_points={
        "console_scripts": ["elkapod_comm_server = elkapod_sim.webots_bringup:main"],
    },
)
